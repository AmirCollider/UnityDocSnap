...
namespace AmirCollider.UnityDocSnap.Editor
{
    ...
    public static class DocSnapAPI
    {
        ...
        private static DocSnapResult Run(Action action)
        {
            ...
            {
                return Failure(
                    "Scripted and command-line exports are part of " + DocSnapConstants.ToolName
                    + " Pro (" + DocSnapConstants.ProPriceDisplay + "). The Editor menu still exports "
                    + "everything your edition includes.\n"
                    + "Editions: " + DocSnapConstants.ProductUrl);
            }
