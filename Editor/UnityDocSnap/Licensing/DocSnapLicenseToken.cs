...
namespace AmirCollider.UnityDocSnap.Editor.Licensing
{
    ...
    internal static class DocSnapLicenseToken
    {
        ...
        public static DocSnapLicenseTokenInfo Verify(string token, string expectedMachineId)
        {
            ...
            // A tier this build does not recognise resolves to Free
            // rather than to the nearest thing it does know. See
            // DocSnapEditionMatrix.Parse: an unknown name is a
            // question, and the safe answer to a question about
            // entitlement is "nothing".
            info.Edition = DocSnapEditionMatrix.Parse(payload.Get("t").AsString(""));
