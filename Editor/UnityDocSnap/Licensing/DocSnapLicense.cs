...
namespace AmirCollider.UnityDocSnap.Editor.Licensing
{
    ...
    internal sealed class DocSnapLicenseStatus
    {
        ...
        // Any paid tier. Most of the UI wants this rather than
        // IsPro: a Plus customer has bought something, and a
        // screen that greets them as a free user because the
        // check asked the wrong question is a bad way to meet
        // somebody who paid.
        public bool IsPaid { get { return Edition > DocSnapEdition.Free; } }
        ...
        // customer already paid, and quoting them an upgrade
        // price would be insulting.
    ...
    internal static class DocSnapLicense
    {
        ...
        // Any paid tier. See DocSnapLicenseStatus.IsPaid: this is
        // the question almost every screen actually means.
        public static bool IsPaid
        {
            get { return Edition > DocSnapEdition.Free; }
        }
