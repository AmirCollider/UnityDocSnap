...
.ds-go-card-head h3, .ds-asset-card-head h3 { font-size: 18px; margin: 0; display: flex; align-items: center; gap: 8px; }
...
/* ==========================================
   Field Table
   ========================================== */
.ds-field-table { width: 100%; border-collapse: collapse; font-size: 13px; }
.ds-field-table th {
  text-align: start;
  font-family: var(--font-display);
  font-size: 11px;
...
.ds-field-table td { padding: 7px 10px; border-bottom: 1px solid var(--line); vertical-align: top; }
.ds-field-table tr:last-child td { border-bottom: none; }
.ds-field-name { font-weight: 700; white-space: nowrap; }
.ds-field-type { color: var(--ink-soft); font-family: var(--font-mono); font-size: 11.5px; white-space: nowrap; }
.ds-field-value { font-family: var(--font-mono); font-size: 12.5px; word-break: break-word; }

.ds-nested-table { margin: 4px 0; background: var(--cream-deep); border-radius: var(--radius-sm); }
